// UARTtest.c
// This is a document contains multiple testing code.
// rename the main program/function you want to run as main()
// rename main functions that you DO NOT want to run as mainX(), where X is positive int
// October 28, 2022
